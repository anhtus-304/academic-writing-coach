...
export default function SignUpPage() {
  ...
  const [email, setEmail] = useState("vi.docao@student.edu.vn");
    ...
    <div className="bg-gray-50 min-h-screen flex items-center justify-center p-4">
      <div className="bg-white w-full max-w-md rounded-2xl shadow-lg border border-gray-100 p-8">
        ...
        <p className="text-sm text-gray-500 text-center mb-6">
          Bắt đầu hành trình nghiên cứu học thuật của bạn cùng AI Coach.
        </p>
        ...
        >
          <span>⚡</span>
          <span>{loading ? "Đang tạo tài khoản..." : "Đăng ký nhanh (Chế độ Thử nghiệm)"}</span>
        </button>
        ...
        <form className="space-y-4" onSubmit={handleDevRegister}>
          <div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-purple-600 text-white rounded-lg py-2.5 text-sm font-medium hover:bg-purple-700 transition mt-2 block text-center shadow-sm"
          >
