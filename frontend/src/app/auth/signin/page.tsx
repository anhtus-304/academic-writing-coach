  ...
  return (
    <div className="bg-gray-50 min-h-screen flex items-center justify-center p-4">
      <div className="bg-white w-full max-w-md rounded-2xl shadow-lg border border-gray-100 p-8">
        ...
        <p className="text-sm text-gray-500 text-center mb-8">Đăng nhập vào AI Academic Writing Coach để tiếp tục hoàn thiện luận văn của bạn.</p>
        ...
        {/* Form đăng nhập thường (Dự phòng) */}
        <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Email</label>
            <input type="email" placeholder="you@student.edu.vn" className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm outline-none focus:border-purple-500 focus:ring-1 focus:ring-purple-500 text-gray-900" />
          </div>
          <div>
            <div className="flex items-center justify-between mb-1">
              <label className="block text-sm font-medium text-gray-700">Mật khẩu</label>
              <a href="#" className="text-xs text-purple-600 hover:underline">Quên mật khẩu?</a>
            </div>
          ...
          <Link href="/dashboard" className="w-full bg-purple-600 text-white rounded-lg py-2.5 text-sm font-medium hover:bg-purple-700 transition block text-center shadow-sm">
            Đăng nhập
          </Link>
        </form>

        <p className="text-center text-sm text-gray-600 mt-8">
          Chưa có tài khoản? <Link href="/auth/signup" className="text-purple-600 font-medium hover:underline">Đăng ký ngay</Link>
        </p>
